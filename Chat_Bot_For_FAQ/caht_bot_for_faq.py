...
Original file is located at
    https://colab.research.google.com/drive/1vz23sKPgc9_bseOQfJmcnXQjjShADuF9
"""
...
if __name__ == "__main__":
    flag = True
    print("Hello, there my name is Aneka. how can i help you. If you want to exit, just type Bye!")
    while(flag==True):
        print("You: ", end='')
        user_response = input()
        print(" ")
